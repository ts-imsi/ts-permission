...
maxFrac:3,posPre:"",posSuf:"",negPre:"-",negSuf:"",gSize:3,lgSize:3},{minInt:1,minFrac:2,maxFrac:2,posPre:"\u00a4",posSuf:"",negPre:"(\u00a4",negSuf:")",gSize:3,lgSize:3}],CURRENCY_SYM:"$"},DATETIME_FORMATS:{MONTH:"一月,二月,三月,四月,五月,六月,七月,八月,九月,十月,十一月,十二月".split(","),SHORTMONTH:"一,二,三,四,五,六,七,八,九,十,十一,十二".split(","),DAY:"星期天,星期一,星期二,星期三,星期四,星期五,星期六".split(","),SHORTDAY:"日,一,二,三,四,五,六".split(","),
